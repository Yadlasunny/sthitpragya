        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(250px, 1fr))', gap: '16px', marginBottom: '40px' }}>
          <ScrollReveal delay={100}>
            <div className="card" style={{ borderLeft: '4px solid #FF3CAC' }}>
              ...
              <div style={{ fontSize: '1.1rem', fontWeight: 600 }}>73% of students feel emotionally lost and unsupported at school</div>
            </div>
          </ScrollReveal>
          ...
          <ScrollReveal delay={200}>
            <div className="card" style={{ borderLeft: '4px solid #FF3CAC' }}>
              ...
              <div style={{ fontSize: '1.1rem', fontWeight: 600 }}>Student mental health crises have tripled in the last decade</div>
            </div>
          </ScrollReveal>
          ...
          <ScrollReveal delay={300}>
            <div className="card" style={{ borderLeft: '4px solid #FF3CAC' }}>
              ...
              <div style={{ fontSize: '1.1rem', fontWeight: 600 }}>Fewer than 1 in 5 school students meet basic physical fitness standards</div>
            </div>
          </ScrollReveal>
        </div>

        <ScrollReveal>
          <p style={{ textAlign: 'center', fontSize: '1.2rem', maxWidth: '700px', margin: '0 auto', color: 'var(--text-primary)', lineHeight: 1.7 }}>
