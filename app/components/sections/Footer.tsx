      ...
      <div className="container">
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '40px', marginBottom: '40px' }}>
          <div>
            ...
            <p style={{ fontSize: '0.95rem', color: 'var(--text-secondary)' }}>Stable in Wisdom.<br />Unstoppable in Life.</p>
          </div>

          <div>
            <h4 style={{ marginBottom: '12px', fontWeight: 600 }}>Quick Links</h4>
            <ul style={{ listStyle: 'none' }}>
              {['Our Method', 'Platform', 'For Schools', 'Results'].map((link, i) => (
                <li key={i} style={{ marginBottom: '8px' }}><a href="#" style={{ color: 'var(--text-secondary)', textDecoration: 'none' }}>{link}</a></li>
              ))}
            </ul>
          </div>

          <div>
            <h4 style={{ marginBottom: '12px', fontWeight: 600 }}>Legal</h4>
            <ul style={{ listStyle: 'none' }}>
          ...
          <div>
            <h4 style={{ marginBottom: '12px', fontWeight: 600 }}>Follow Us</h4>
            <ul style={{ listStyle: 'none' }}>
        ...
        <div style={{ borderTop: '1px solid var(--border)', paddingTop: '30px', textAlign: 'center', color: 'var(--text-secondary)', fontSize: '0.9rem' }}>
