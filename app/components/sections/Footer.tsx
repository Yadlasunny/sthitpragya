    ...
    <footer style={{ background: 'rgba(3, 3, 10, 0.8)', borderTop: '1px solid var(--border)', padding: '60px 20px 30px' }}>
      <div className="container">
        ...
        <div style={{ borderTop: '1px solid var(--border)', paddingTop: '30px', textAlign: 'center', color: 'var(--text-secondary)', fontSize: '0.9rem', fontFamily: 'Inter' }}>
          <p>© 2026 Sthitpragya. All rights reserved. Built with <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24"><g fill="none" stroke="currentColor" strokeLinejoin="round" strokeWidth="1.5"><path strokeLinecap="round" d="M12 12a4 4 0 1 0 0-8a4 4 0 0 0 0 8"/><path d="M22 17.28a2.28 2.28 0 0 1-.662 1.606c-.976.984-1.923 2.01-2.936 2.958a.597.597 0 0 1-.823-.017l-2.918-2.94a2.28 2.28 0 0 1 0-3.214a2.277 2.277 0 0 1 3.233 0l.106.107l.106-.107A2.277 2.277 0 0 1 22 17.28Z"/><path strokeLinecap="round" d="M5 20v-1a7 7 0 0 1 10-6.326"/></g></svg> for students everywhere.</p>
        </div>
      </div>
    </footer>
  );
