      ...
      <div className="container">
        <ScrollReveal>
          <div style={{ marginBottom: '24px' }}>
            ...
            <p style={{ fontSize: 'clamp(0.9rem, 4vw, 1.2rem)', color: 'var(--text-secondary)', maxWidth: '600px', margin: '0 auto 40px' }}>
          ...
          <div style={{ display: 'flex', gap: '12px', justifyContent: 'center', marginBottom: '40px', flexWrap: 'wrap', flexDirection: 'column', alignItems: 'stretch' }}>
            <button className="btn-primary" style={{ fontSize: '1rem', padding: '18px 40px' }}>Register Your School — It's Free →</button>
            <button className="btn-secondary" style={{ fontSize: '1rem', padding: '18px 40px' }}>Contact Us →</button>
          </div>

          <div style={{ display: 'flex', justifyContent: 'center', gap: '12px', fontSize: 'clamp(0.75rem, 3vw, 0.95rem)', color: 'var(--text-secondary)', flexWrap: 'wrap' }}>
